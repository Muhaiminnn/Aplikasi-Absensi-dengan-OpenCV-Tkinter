...
class FaceDataRecorder:
    def __init__(self, root):
        ...
        #self.label.grid(row=1, rowspan=4, column=3,padx=20, pady=5)
    ...
    def rekam_data(self):
        ...
        while True:
            ...
            for (x, y, w, h) in faces:
                ...
                # Menulis data ke dalam file txt untuk identifikasi wajah
    ...
    '''def trainingWajah(self):
        ...
        def getImageLabel(path):
            ...
            for imagePath in imagePaths:
                ...
                nama = str(os.path.split(imagePath)[-1].split('_')[1])
